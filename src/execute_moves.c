...
/*   Updated: 2024/07/27 11:45:14 by pmarkaid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	print_moves(t_move move)
{
	if (move == SA)
		ft_putstr_fd("sa\n", 1);
	else if (move == PA)
...
static void	execute_rr(t_node **a, t_node **b, int *costs)
{
	int	common;
	int	extra;
...
static void	execute_rrr(t_node **a, t_node **b, int *costs)
{
	int	common;
	int	extra;
